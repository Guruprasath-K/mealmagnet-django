...
class Res(models.Model):
    ...
    Drinks=models.CharField(max_length=122, default='Drinks')
    Soups=models.CharField(max_length=122, default='Soups')
    Dishes=models.CharField(max_length=122, default='Dishes')
